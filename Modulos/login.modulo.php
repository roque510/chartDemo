    ...
    <div class="row">
        ...
        <div class=" col m6 center" style ="margin-top: 0%;">
            ...
            <div id="id_logo" class="col m12">
                <img src="img/logo.png" alt="Sistema Demo" height="100%" width="62%" style="border:0px;margin-left:16%; margin-bottom:20px;float:left;">
            </div>
            <!--<h2>CrediStart</h2>-->
            <!--<img src="logo.png" height="100%" width="100%">-->
            <div class="row container center-align" style="margin: 0px auto;"> <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam."<br><br>
             <i>“A.Roque Solutions”</i> &copy</p></div>
